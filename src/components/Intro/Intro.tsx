...
const Intro = () => {
  return (
    <section className='mb-20 max-w-[50rem] text-center sm:mb-0'>  {/* Image Area*/}
      ...
      >
        <Link href="#contact" className='bg-gray-900 text-white px-7 py-3 flex items-center gap-2 rounded-full shadow-md outline-none focus:scale-110 hover:bg-gray-950 hover:scale-110 active:scale-105 transition-all'>Contact me here<BsArrowRight className='opacity-70'/></Link>
